...
public class FileDownloader {
    ...
    private String localDownloadPath = "test-output/";
    private boolean followRedirects = true;
    private boolean mimicWebDriverCookieState = true;
    private int httpStatusOfLastDownloadAttempt = 0;
    File renamedFile;
 
    public FileDownloader(WebDriver driverObject, File file) {
	...
	private String downloader(WebElement element, String attribute) throws IOException, NullPointerException, URISyntaxException {
        ...
        response.getEntity().getContent().close();
 		FileUtils.moveFile(downloadedFile, this.renamedFile);
        String downloadedFileAbsolutePath = this.renamedFile.getAbsolutePath();
